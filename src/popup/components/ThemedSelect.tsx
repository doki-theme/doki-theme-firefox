...
function ThemedSelect<Option,
  ...
  Group extends GroupBase<Option> = GroupBase<Option>>(props: StateManagerProps<Option, IsMulti, Group>) {
        ...
        return <Select {...props}
                       ...
                       styles={{
                         ...
                         option: (provided, state) => ({
                           ...provided,
                           backgroundColor: state.isFocused || state.isSelected ? colors.selectionBackground : provided.backgroundColor,
                           borderBottom: `1px dotted ${colors.infoForeground}`,
                           color: state.isFocused || state.isSelected ? colors.selectionForeground : colors.foregroundColorEditor,
                           ":hover": {
                             ...provided[":hover"],
